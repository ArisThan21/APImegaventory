...
class MegaventorySales:
    ...
    def createSales(self, sku, name, currency, inventoryLocationID, quantity):
      data = {
        "APIKEY": "6945f581fc8e7cef@m150627",
        "mvSalesOrder":{
...
try:
    ...
    product_data = megaventoryProduct.create_product("1112223", " Puma sneakers", "Category A", "Gram(s)", "Dummy Supplier A", 79.99, 35.99)
    product_data1 = megaventoryProduct1.create_product("1112299", "New Balance sneakers","Category A", "Gram(s)", "Dummy Supplier A", 89.99, 39.99)
    time.sleep(2)
    client = Megaventoryclient.createClient("Achilles", " achilles@exampletest.com", "Example 5, Athens", "9876543210","Shipping1","EUR")
    supplier = Megaventoryclient1.createClient("Helen", "helen@exampletest.com", " Example 6, Athens", " 9876543233","Shipping1","EUR")
    time.sleep(2)
    inventory = Megaventoryinventory.createInventory("Demo", "Demo Project Location", " Example 25, Athens")
    time.sleep(2)
    purchase = megaventoryPurchase.createPurchase("1112299", "New Balance","something","EUR","5", 20)
    time.sleep(2)
    sales = Megaventorysales.createSales("1112223","Puma sneakers","EUR","5", 15)
    time.sleep(2)
    quantity = Megaventoryquantity.UpdateQuantity("1112223", 15, 5)
